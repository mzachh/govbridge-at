...
4. On 2026-09-03 the user selected MIT for the original project, including fictional fixtures, replacing the earlier CC0 proposal. Root and standalone demo LICENSE files and package metadata now declare MIT. Third-party licenses remain unchanged. Licensing changes are public in commit `0449dda`, and GitHub recognizes the MIT License (verified on 2026-09-03).
